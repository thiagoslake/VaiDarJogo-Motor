...
class CriarTeste1Minuto {
    ...
    async criarTeste1Minuto() {
        try {
            console.log('🚀 ===== CRIANDO TESTE 1 MINUTO =====\n');
    ...
    async criarSessao1Minuto() {
        try {
            ...
            const sessaoData = {
                ...
                status: 'scheduled',
                attendance_count: 0,
                notes: 'TESTE 1 MINUTO - Notificação imediata'
            };
...
async function main() {
    const teste = new CriarTeste1Minuto();
    await teste.criarTeste1Minuto();
}
...
module.exports = CriarTeste1Minuto;
