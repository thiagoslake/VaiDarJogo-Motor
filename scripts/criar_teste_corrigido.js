...
/**
 * 🚀 CRIAR TESTE CORRIGIDO
 * 
 * Este script cria uma sessão de teste com horário muito próximo
 * para testar o motor com o erro de schema corrigido.
 */
...
class CriarTesteCorrigido {
    ...
    async criarTesteCorrigido() {
        try {
            console.log('🚀 ===== CRIANDO TESTE CORRIGIDO =====\n');
    ...
    async criarSessao1Minuto() {
        try {
            ...
            const sessaoData = {
                ...
                status: 'scheduled',
                attendance_count: 0,
                notes: 'TESTE CORRIGIDO - Schema corrigido'
            };
...
async function main() {
    const teste = new CriarTesteCorrigido();
    await teste.criarTesteCorrigido();
}
...
module.exports = CriarTesteCorrigido;
