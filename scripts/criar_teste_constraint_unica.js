...
/**
 * 🚀 CRIAR TESTE CONSTRAINT ÚNICA
 * 
 * Este script cria uma sessão de teste para o motor completo
 * com o erro de constraint única corrigido.
 */
...
class CriarTesteConstraintUnica {
    constructor() {
        // Configurar Supabase
    ...
    async criarTesteConstraintUnica() {
        try {
            console.log('🚀 ===== CRIANDO TESTE CONSTRAINT ÚNICA =====\n');
    ...
    async criarSessao1Minuto() {
        try {
            ...
            const sessaoData = {
                ...
                status: 'scheduled',
                attendance_count: 0,
                notes: 'TESTE CONSTRAINT ÚNICA - Verificação de duplicatas corrigida'
            };
    ...
    async mostrarInstrucoes(sessao, config) {
        try {
            ...
            console.log('\n   ⚠️ IMPORTANTE:');
            console.log('   📝 Este é um TESTE CONSTRAINT ÚNICA - sem erros');
...
async function main() {
    const teste = new CriarTesteConstraintUnica();
    await teste.criarTesteConstraintUnica();
}
...
module.exports = CriarTesteConstraintUnica;
