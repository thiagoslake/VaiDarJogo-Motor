-- 🗄️ SCHEMA - CONFIGURAÇÕES DE NOTIFICAÇÕES
-- 📅 Data: $(date)
...
-- Índices para participation_confirmations
...
-- Trigger para participation_confirmations
...
-- Habilitar RLS para participation_confirmations
